...
export default async function CourseDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="min-h-screen max-w-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
                                            ...
                                            <AccordionTrigger className="hover:no-underline">
                                                <div className="flex items-start sm:items-center gap-2 sm:gap-4 text-left flex-1 pr-2">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <Badge
                                                            variant="outline"
                                                            className="mt-1.5 sm:mt-2 text-[10px] sm:text-xs inline-flex"
                                                        >
